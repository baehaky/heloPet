    ...
    return (
      <>
        <section>
          <div
            role="status"
            className="bg-teal-400 min-h-screen flex justify-center items-center"
          >
            <svg
              aria-hidden="true"
              className="w-12 h-12 text-gray-200 animate-spin fill-yellow-400"
              viewBox="0 0 100 101"
              fill="none"
