...
export default function RegisterPage() {
  return (
    <div className="min-h-[100dvh] flex items-center justify-center px-5 py-5">
        ...
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              ...
              <p>Silahkan isi bidang yang kosong</p>
            </div>
            <div>
              <div className="flex -mx-3">
                <div className="w-1/2 px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="text"
                      className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-400"
                      placeholder="John"
                    />
                  </div>
                </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-12">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="password"
                      className="w-full -ml-10 pl-10 pr-3 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-400"
                      placeholder="************"
                    />
                  </div>
                </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <Link
                    to="/"
                    className="text-center block w-full max-w-xs mx-auto bg-teal-400 hover:bg-teal-700 focus:bg-teal-400 text-white rounded-lg px-3 py-3 font-semibold"
                  >
                    KEMBALI
                  </Link>
                </div>
                <div className="w-full px-3 mb-5">
                  <button className="block w-full max-w-xs mx-auto bg-teal-400 hover:bg-teal-700 focus:bg-teal-400 text-white rounded-lg px-3 py-3 font-semibold">
                    DAFTAR SEKARANG
                  </button>
                </div>
              </div>
