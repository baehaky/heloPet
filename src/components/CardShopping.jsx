  ...
  return (
    <div className="bg-white shadow-md rounded-lg max-w-xs dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="px-5 pb-5">
        <h3 className="text-gray-900 lg:text-left text-center font-semibold text-lg tracking-tight dark:text-white">
          {products.name}
        </h3>
        <div className="flex items-center flex-col gap-y-5 mt-5">
          ...
          <button className="text-white bg-teal-400 hover:bg-teal-600 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            Add to cart
          </button>
        </div>
      </div>
